...
export function SocialProofSection() {
  ...
  const copy = {
    en: {
      ...
      title: "Every immigrant family deserves a fair shot at homeownership.",
      p1: "Too many immigrant families come to America with the dream of owning a home. And too many hear \"no\" from a bank without understanding why — or what to do next.",
    ...
    pt: {
      ...
      title: "Toda família imigrante merece uma chance justa.",
      p1: "Muitas famílias imigrantes vêm para a América com o sonho de ter uma casa. E muitas ouvem \"não\" do banco sem entender o porquê — ou o que fazer a seguir.",
    ...
    es: {
      ...
      title: "Toda familia inmigrante merece una oportunidad justa.",
      p1: "Demasiadas familias inmigrantes vienen a América con el sueño de tener una casa. Y demasiadas escuchan \"no\" del banco sin entender por qué — ni qué hacer a continuación.",
    ...
    fr: {
      ...
      title: "Chaque famille immigrante mérite une chance équitable.",
      p1: "Trop de familles immigrantes viennent en Amérique avec le rêve d'avoir une maison. Et trop entendent \"non\" de la banque sans comprendre pourquoi — ni quoi faire ensuite.",
